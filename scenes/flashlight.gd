...
func _process(delta: float) -> void:
	...
	if (Input.is_action_just_pressed("flashlight_scroll_up")):
		...
		texture_inner.rotation_degrees = lerpf(texture_inner.rotation_degrees, 90, 0.5)		
	...
	# Tighten light
		...
		texture_inner.rotation_degrees = lerpf(texture_inner.rotation_degrees, 0, 0.5)	
